...
const styles = (m, c) => ({
  ...
  modal: { background: c.modalBg, border: `1px solid ${c.cardBorder}`, borderRadius: "16px", width: "100%", maxWidth: m ? "100%" : "640px", maxHeight: "80vh", display: "flex", flexDirection: "column", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" },
